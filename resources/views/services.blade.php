                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="img/israel1.jpg" alt="Image" class="tm-service-img">
                            <div class="media-body tm-service-text">
                                <h2 class="mb-4 tm-content-title">Israel Rodriguez Moreno</h2>
                                <p>Desarrollador encargado del proyecto y director en jefe</p>
                            </div> 
                        </div>
                        <div class="media my-3 mb-5 tm-service-media">                            
                            <div class="media-body tm-service-text">
                                <h2 class="mb-4 tm-content-title">Monserrat Bello Arismendi</h2>
                                <p>Encargada del diseño de la pagina y desarrollo de la misma</p>
                            </div>  
                        ...
                        <div class="media my-3 tm-service-media tm-service-media-img-l">
                            ...
                            <div class="media-body tm-service-text">
                                ...
                                <p>Primer encargado de la investigación y apoyo del desarrollo del blog web</p>
                            </div> 
                        </div>  
                        <div class="media my-3 mb-5 tm-service-media">                            
                            <div class="media-body tm-service-text">
                                <h2 class="mb-4 tm-content-title">Eduardo Viñas Valdez</h2>
                                <p>Soporte tecnico y segundo encargado de investigación</p>
                            </div>  
                            <img src="img/Eduardo3.jpg" alt="Image" class="tm-service-img-r">
                        </div>                    
                    </section>
                </main>
            </div>
